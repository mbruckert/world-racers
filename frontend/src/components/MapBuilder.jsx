      ...
      <div className="flex flex-col items-center justify-start min-h-screen p-4 bg-indigo-100">
         ...
         <div className="w-full max-w-xl p-4 mb-4">
            ...
            >
               ...
               />
               <button onClick={handleGeocode} className="ml-2 text-gray-600 text-xl">
         ...
         <div className="flex gap-4 mt-4">
            ...
            >
               <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" strokeWidth={3} stroke="currentColor"         className="size-6">
            ...
            <button
               ...
               className="w-12 h-12 rounded-[16px] bg-white flex items-center justify-center text-blue-500"
